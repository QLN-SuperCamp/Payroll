...
function createTableEntryHourly(table, firstName, lastName, regHours, otHours, dtHours, sickHours, totalHours, deductionTotal, checkLocation, payPeriodNumber) {
    ...
    if (stlStipend.find(object => object.name === fullName)) {
        if (payPeriodNumber === stlStipend.find(object => object.name === fullName).finalPayPeriod) {
...
function createTableEntrySalary(table, firstName, lastName, salaryPayTotal, checkLocation, payPeriodNumber) {
    ...
    const correspondingStipendObject = travelStipends.find(object => object.name === fullName);
    ...
    const correspondingSpecialContract = specialContracts.find(object => object.name === fullName);
    ...
    if (correspondingSpecialContract !== undefined) {
        if (correspondingSpecialContract.payPeriods.find(object => object.payPeriodNumber === payPeriodNumber)) {
            correspondingPayPeriodObject = correspondingSpecialContract.payPeriods.find(object => object.payPeriodNumber === payPeriodNumber);
        }

        if (correspondingPayPeriodObject !== '') {
            correspondingTotalPay = correspondingSpecialContract.payPeriods.find(object => object.payPeriodNumber === payPeriodNumber).totalPay;
        }
    }
...
function assignTableBody(table) {
    ...
    let tableArray = [table1CAHourly, table1CASalary, table1TXHourly, table1TXSalary, table2CAHourly, table2FLHourly, table2TXHourly, table2PAHourly, table2CASalary, table2FLSalary, table2TXSalary, table2PASalary, table3PAHourly, table3PASalary, table3FLSalary, table3CASalary, table3CAHourly, table3FLHourly, table4CAHourly, table4CASalary];
    let bodyArray = [body1CAHourly, body1CASalary, body1TXHourly, body1TXSalary, body2CAHourly, body2FLHourly, body2TXHourly, body2PAHourly, body2CASalary, body2FLSalary, body2TXSalary, body2PASalary, body3PAHourly, body3PASalary, body3FLSalary, body3CASalary, body3CAHourly, body3FLHourly, body4CAHourly, body4CASalary];
