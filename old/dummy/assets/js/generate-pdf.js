function generatePDF() {
    ...
    var decycledDoc = JSON.decycle(doc);
    console.log("decycledDoc");
    console.log(decycledDoc);

    var stringDoc = JSON.stringify(decycledDoc);
    console.log("stringDoc");
    console.log(stringDoc);

    var parsedDoc = JSON.parse(stringDoc);
    console.log("parsedDoc");
    console.log(parsedDoc);

    var cycledDoc = JSON.retrocycle(parsedDoc);
    console.log("cycledDoc");
    console.log(cycledDoc);
