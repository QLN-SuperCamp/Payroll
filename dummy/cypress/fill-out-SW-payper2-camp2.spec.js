...
Cypress.Commands.add("fillSiteInfoBrittany", (site, camp, month, day) => {
    cy.visit('/');
...
*/
context("Generate Southwestern University Data", function () {
    var tlsToUncheck = [];
    ...
    context("SW", function () {
        context("Camp 2", function () {
            it("July 2nd (Day -1)", function () {
                cy.fillSiteInfoBrittany("site-sw", "sw-camp2", "7", "2");
            ...
            it("July 3rd (Day 1)", function () {
                cy.fillSiteInfoBrittany("site-sw", "sw-camp2", "7", "3");

                addStaff("Gary Clack", "TL", 13, 0);
                addStaff("Jules Damey-Fernandez", "TL", 13, 0);
                addStaff("Kayla Miller", "TL", 13, 0);
            ...
            it("July 4th (Day 2)", function () {
                cy.fillSiteInfoBrittany("site-sw", "sw-camp2", "7", "4");
            ...
            it("July 5th (Day 3)", function () {
                cy.fillSiteInfoBrittany("site-sw", "sw-camp2", "7", "5");
            ...
            it("July 6th (Day 4)", function () {
                cy.fillSiteInfoBrittany("site-sw", "sw-camp2", "7", "6");
            ...
            it("July 7th (Day 5)", function () {
                cy.fillSiteInfoBrittany("site-sw", "sw-camp2", "7", "7");
            ...
            it("July 8th (Day 6)", function () {
                cy.fillSiteInfoBrittany("site-sw", "sw-camp2", "7", "8");
